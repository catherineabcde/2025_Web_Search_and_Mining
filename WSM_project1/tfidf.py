...
"""
Textblob will need some NLTK corpora for initialization (stopwords, etc.)
"""

def tf(word, blob):
    """
    tb_object.words is a list of words in the document
...
def n_containing(word, bloblist):
    """
    n_containing = number of documents that contain the word
    """
...
for i, blob in enumerate(bloblist):
    ...
    # sort the words by their tfidf score in descending order
